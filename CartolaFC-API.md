...
Essas informações não são oficiais da API, portanto não é garantido que o padrão de consulta seja mantido ou até mesmo a disponibilidade da API tenha garantia.
***
